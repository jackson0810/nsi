...
<cfoutput><!---BEGIN EDITABLE REGION--->
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" height="300px;" width="78%" style="padding-left:5px;	">
			...
			<p>
				These items are excess <u><a href="/views/documents/Warehouse80Inventory.pdf">inventory for sale</a></u>. Make us an offer.<br/><br/>To make an offer please contact:
				<br/><br/>
