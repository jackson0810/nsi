...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L</title>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" height="300px;" width="78%" style="padding-left:5px;	">
			<h1>Manufacturing, Repair, Overhaul and Logistics (MRO&L)</h1>
			...
			<p>
				Naval Systems Incorporated (NSI), a Veteran owned small business with a Manufacturing, Repair, Overhaul and Logistics (MRO&L)
				Division located in Jacksonville, Florida. We specialize in the remanufacturing and rework of aerospace components and can
				provide a complete range of supply chain management functions and services.
			</p>
			<p>
				We are an FAA certified provider of Avionics, Instruments and Test Equipment repair and overhaul. Our experiences in the role of
				third party integrator are reflected in current performance under several Performance Based Logistics contracts. NSI MRO&L provides
				the highest quality products and services at competitive prices, being registered to ISO9000, AS9100, AS9110, and AS9120 international
				quality standards. We are members of the National Society of Safety Professionals and the NE FL Safety Council.
			</p>
			<p>
				Our dedicated senior management team brings over 150 years of military and business operations experience to each and every task
				as well as an uncompromising devotion to performance excellence.
			</p>
			<br/>
			<table border="0">
				<tr>
					<td width="50%">
						...
						<ul style="padding-left:15px;">
							...
							<li>Authorized FAA Repair Facility</li>
							<li>Approved FAA Training Plan</li>
							<li>Quick Turn Around</li>
							<li>Warranty Provided</li>
							<li>Outstanding Customer Service</li>
							<li>Outstanding Reputation</li>
						</ul>
					</td>
					<td align="left" width="50%">
						<img src="/images/MROBanner2.gif">
					</td>
				</tr>
			</table>
			<br/>
