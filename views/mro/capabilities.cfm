...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L (Capabilities)</title>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" height="300px;" style="padding-left:5px;">
			<h1>Capabilities</h1>
			<ul style="padding-left:15px;">
				<li>Manufacture New From Prints or Drawings</li>         
				<li>Manufacture From Sample</li>
				<li>Manufacture Prototypes</li>
				<li>Close Tolerances (to .001�)</li>
				<li>Repair of Machined Parts</li>
				<li>Removal of Broken Studs and Bolts</li>
				<li>Thread Repair</li>
				<li>Sheet Metal Repair</li>
				<li>All Metals, Plastics</li>
				<li>Strip, Prime & Paint</li>

			</ul>
		</td>
		<td align="center" style="padding-right:5px;">
			<img src="/images/machineLightCapabilities.gif" />
			<h2>We can expand to meet your requirements.</h2>
		</td>
	</tr>
</table>
<!---END EDITABLE REGION--->
