...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L (Equipment)</title>
	...
	<tr>
		...
		<td valign="top" height="300px;" style="padding-left:5px;">
			...
			<ul style="padding-left:15px;">
				<li>
					Three Axis CNC Vertical Machining Center
					<ul style="padding-left:15px;">
						<li>Z 20", Y 20", X40"</li>
					</ul>
				</li>
				<li>
					Lathes
					<ul style="padding-left:15px;">
						<li>2 1/8" Thru Hole Spindle, 8 1/2" Swing Over Bed, 60" Between Centers"</li>
					</ul>
				</li>
				<li>
					Mills
				...
				<li>
					...
					<ul style="padding-left:15px;">
						<li>Saws, Grinders, Drills, etc.</li>
					</ul>
				</li>
				<li>75 Ton Hydraulic Arbor Press</li>
				<li>Sand Blaster</li>
				<li>Box Pan Brake</li>
				<li>Cross Flow, Drive In Paint Booth</li>
				<li>Open Face Paint Booth</li>
				<li>Pressurized Spray Wash Cabinet</li>
			</ul>
		</td>
		<td align="center" style="padding-right:5px;">
			<img src="/images/machineLightEquipment.gif" />
		</td>
	</tr>
</table>
<!---END EDITABLE REGION--->
