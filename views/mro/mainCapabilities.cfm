...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L (Main Capabilities)</title>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" height="300px;" width="78%" style="padding-left:5px;	">
			<h1>Capabilities</h1>
			<p>
				Items listed on the "Active" Capabilities list reflect repair items that can be worked upon receipt of an approved contract.
			</p>
			<p>
 				Items appearing on the "InActive" Capabilities list, as well as items in the same "Families" as those on the "Active" or "Inactive" list, may require additional lead time to re-establish capabilities.
			</p>

			<p>Once you've downloaded one or both of the documents below, you may search by NSN or other criteria by using the "Find" option.</p> 


				<ul style="padding-left:15px;">
					<li><a href="/views/documents/Capabilities.pdf" title="NSI Active Capabilities" target="_blank" >NSI Active Capabilities</a></li>
					<li><a href="/views/documents/NSI_Cap_List_Feb_2010_inactive.pdf" title="NSI In-Active Capabilities" target="_blank">NSI InActive Capabilities</a></li>
				</ul>
