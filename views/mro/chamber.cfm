...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L (Avionics-Chamber)</title>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" height="300px;" width="78%" style="padding-left:5px;">
			<h1> Environmental Chamber For Temperature & Humidity Control During Instrument Calibration</h1>
			<img src="/images/chamber.gif" />
			<br/>
