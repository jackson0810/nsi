...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L (Inventory)</title>
		...
		<tr>
			...
			<td valign="top" height="300px;" style="padding-left:5px;">
				...
				<ul style="padding-left:15px;">
					...
					<li>AS9100:2004 Registered</li>
					<li>Quality Product</li>
					<li>Proven Track Record</li>
					<li>Satisfied Customers</li>
					<li>Authorized Lockheed Martin Repair Facility</li>
					<li>Reliable Vendors
						<ul style="padding-left:15px;">
							<li>
								Special Processes
			...
			<td align="center" style="padding-right:5px;">
				<img src="/images/machineLightServices1.gif" />
				<br/><br/>
				<img src="/images/machineLightServices2.gif" />
			</td>
		</tr>
	</table>
	<!---END EDITABLE REGION--->
