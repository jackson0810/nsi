...
<html>
	<head>
		...
		<title>Naval Systems, Inc. - MRO&L (Machine)</title>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top" height="300px;" width="78%" style="padding-left:5px;	">
			<h1>Machine/Light Manufacturing</h1>
			<p>
				We operate a close tolerance CNC Machine Shop (Cage Code 5AQV7) employing both computer controlled and conventional milling
				machines.  We manufacture airborne parts, test set face plates, numerous machined spare parts, and sheet metal pieces for
				aircraft external stores.  We manufacture high grade stainless steel, and aircraft aluminum pieces from drawings, sample parts,
				or of our own design.  We apply corrosion prevention systems, PMB and sand blast, and paint using both commercial and Military
				Standard coatings.
			</p>
			<br/><br/>
			<div align="center">
				<img src="/images/machinelight.gif" />
			</div>
		</td>
	</tr>
</table>
