...
Version: 1.1.0.1578
Built-on: 2009-05-29 00:37:58
$Id: README 1491 2009-04-28 19:11:03Z peterfarrell $
------------------------------------------------
...
if you do not specify this property.  You can disable the login page like this:
...
application is deployed to production in this manner.  If you are using Mach-II 1.8,
you enable the login page by environment group or explicit environment name. The following
example disables the login page for all environments that belong to the "local"
and "development" environment groups and an explicit environment name "fooBar".  If your 
...
found. Environment value resolution is only available in Mach-II 1.8+. 
