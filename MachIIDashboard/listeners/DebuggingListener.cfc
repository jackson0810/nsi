...
$Id: DebuggingListener.cfc 1546 2009-05-12 21:57:07Z peterfarrell $
...
<cfcomponent
	...
	<cffunction name="flushExceptionViewerDataStorage" access="public" returntype="void" output="false"
		...
		<cfset var message = CreateObject("component", "MachIIDashboard.model.sys.Message").init("Flushed exception viewer data storage.") />
	...
	<cffunction name="changeSnapshotLevel" access="public" returntype="void" output="false"
		...
		<cfset var message = CreateObject("component", "MachIIDashboard.model.sys.Message").init("Changed snapshot level to '#arguments.event.getArg('level')#'.") />
