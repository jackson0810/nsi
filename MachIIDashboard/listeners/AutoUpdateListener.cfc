...
<cfcomponent
	...
	<cffunction name="configure" access="public" returntype="void" output="false"
		...
		<cfset setAutoUpdateService(CreateObject("component", "MachIIDashboard.model.autoUpdate.AutoUpdateService").init(getAppManager().getPropertyManager().getVersion(), getProperty('udfs').getVersionNumber(), getProperty('autoUpdateUrl'))) />
	</cffunction>

	<cffunction name="setAutoUpdateService" access="private" returntype="void" output="false">
		<cfargument name="AutoUpdateService" type="MachIIDashboard.model.autoUpdate.AutoUpdateService" required="true" />
		<cfset variables.AutoUpdateService = arguments.AutoUpdateService />
	</cffunction>
	<cffunction name="getAutoUpdateService" access="private" returntype="MachIIDashboard.model.autoUpdate.AutoUpdateService"  output="false">
